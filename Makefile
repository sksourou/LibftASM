...
SRC = src/ft_isdigit.s src/ft_bzero.s src/ft_isalpha.s src/ft_isupper.s \
		...
		src/ft_strlen.s src/ft_puts.s src/ft_memset.s src/ft_memcpy.s \
		src/ft_strdup.s src/ft_strcat.s src/ft_strcpy.s src/ft_cat.s \
		src/ft_strchr.s src/ft_strrchr.s
OBJ = $(SRC:.s=.o)
